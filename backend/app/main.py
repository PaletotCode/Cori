...
from app.api.routes_activity_templates import router as activity_templates_router
from app.api.routes_auth import router as auth_router
from app.api.routes_form_templates import router as form_templates_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(activity_templates_router)
